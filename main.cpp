    ...
    while (appWindow.isOpen()) {
        ...
        case 2:
            ...
            if (appWindow.isOpen()) {
                ...
                // Draw Magic Button //
                if (magic_option)
                    s.setTextureRect(sf::IntRect(9 * squareSize, squareSize, squareSize, squareSize));
                else
                    s.setTextureRect(sf::IntRect(10 * squareSize, squareSize, squareSize, squareSize));
                s.setPosition(appWindow.getDefaultView().getSize().x / 2 - squareSize / 2, squareSize * 5);
                appWindow.draw(s);
